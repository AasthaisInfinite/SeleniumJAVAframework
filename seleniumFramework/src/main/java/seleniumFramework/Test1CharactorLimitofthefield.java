...
public class Test1CharactorLimitofthefield {
    ...
    public void setupTest() {
        ...
        reporter = new ExtentSparkReporter("extentreport01.html");
    ...
    public void searchAndPrintResults() throws InterruptedException {
        ...
        try {
			...
			Waltscategories.WaltsCategoriesName(driver).sendKeys("T");
			Thread.sleep(2000);
        ...
        try {
            String Validationmessage = Waltscategories.WaltsCategoriesName(driver).getText();
            Assert.assertEquals("Minimum 3 characters are required",Validationmessage);
            test.log(Status.PASS, "Test Passed as Validation is displayed Minimum 3 characters are required");
