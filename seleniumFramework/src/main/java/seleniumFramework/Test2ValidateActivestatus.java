...
public class Test2ValidateActivestatus {
    ...
    public void setupTest() {
        ...
        reporter = new ExtentSparkReporter("extentreport02.html");
  ...
  //  Thread.sleep(2000);
    ...
    Thread.sleep(2000);
        ...
        try {
            String getactivestatus = Waltscategories.checkactivestatus(driver).getText();
            Assert.assertEquals("Active", getactivestatus);
            test.log(Status.PASS, "Test Passed as status is displayed Active");
